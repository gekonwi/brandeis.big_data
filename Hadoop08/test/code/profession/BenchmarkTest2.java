...
public class BenchmarkTest2 {
	...
	public static void testSplit() {
		...
		for (int i = 0; i < counter; i++) {					//same here, manually split which lines are being 
			...
			System.out.println("The input and expected output should match:");
			System.out.println(lineReal);
			System.out.println(lineKnown);
		...
		for (int i = 0; i < 2; i++) {
			...
			boolean compare;				
			int equals = testReal.compareTo(Known);				//lines from solution file should match original
			if (equals == 0) {
				compare = true;
			} else {
				compare = false;
			...
			System.out.println("The input and expected first output should match:");
			System.out.println(lineReal);
			System.out.println(lineSol);
			System.out.println(compare);
			System.out.println("The input should contain the expected output:");
			System.out.println(lineReal);
			System.out.println(lineSol);
