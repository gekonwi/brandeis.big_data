...
public class InvertedIndexMapredTest {
	/*
	 * @Test public void testMapper() { InvertedIndexMapper mapper = new
	 * InvertedIndexMapper(); // TODO to be continued - I need a fake Context
	 * object, // using mocito framework? }
	 * 
	 * }
	 */
	...
	MapReduceDriver<Text, Text, Text, StringInteger, Text, StringIntegerList> mapReduceDriver;
	...
	public void setUp() {
		...
		mapReduceDriver = new MapReduceDriver<Text, Text, Text, StringInteger, Text, StringIntegerList>();
	...
	// mapDriver.withInput(new Text("articleThing"), new
	// Text("<run,5>,<star,3>,<hip,2>"));
	// // compare to expected outputs
	// mapDriver.withOutput(new Text("run"), new
	// StringInteger("articleThing",5));
	// mapDriver.withOutput(new Text("star"), new
	// StringInteger("articleThing",3));
	// mapDriver.withOutput(new Text("hip"), new
	// StringInteger("articleThing",2));
	//
	...
	// // compare to expected outputs
	// reduceDriver.withOutput(new Text("lemma1"), new
	// StringIntegerList(siList));
	//
	// List<Pair<Text, StringIntegerList>> input = reduceDriver.run();
	// List<Pair<Text, StringIntegerList>> output =
	// reduceDriver.getExpectedOutputs();
	//
	// assertEquals("the input and expected output should match",
	// 0, input.toString().compareTo(output.toString()));
	// }
